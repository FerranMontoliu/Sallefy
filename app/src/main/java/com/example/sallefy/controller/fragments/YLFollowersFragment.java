...
public class YLFollowersFragment extends Fragment implements UserCallback, UserAdapterCallback {
    public static final String TAG = YLFollowersFragment.class.getName();

    private RecyclerView mRecyclerView;


    public static YLFollowersFragment getInstance() {
        return new YLFollowersFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        UserManager.getInstance(getContext()).getFollowers(YLFollowersFragment.this);
    ...
    public void onUsersReceived(List<User> users) {
        ...
        UserListAdapter adapter = new UserListAdapter((ArrayList<User>) users, getContext(), YLFollowersFragment.this, R.layout.item_user_list);
