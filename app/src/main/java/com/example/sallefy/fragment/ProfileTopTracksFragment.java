...
import com.example.sallefy.databinding.FragmentProfileTopTracksBinding;
...
public class ProfileTopTracksFragment extends DaggerFragment implements LikeableListAdapter {

    @Inject
    protected ViewModelFactory viewModelFactory;

    private FragmentProfileTopTracksBinding binding;
    private ProfileTopTracksViewModel profileTopTracksViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentProfileTopTracksBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        profileTopTracksViewModel = new ViewModelProvider(this, viewModelFactory).get(ProfileTopTracksViewModel.class);
    ...
    private void subscribeObservers() {
        ...
        if (user == null) return;
        profileTopTracksViewModel.getUserTopTracks(user.getLogin()).observe(getViewLifecycleOwner(), tracks -> {
    ...
    public void onItemLiked(Object item, int position) {
        profileTopTracksViewModel.likeTrack((Track) item, position, adapter);
    }
